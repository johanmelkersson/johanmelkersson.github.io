...
export const TIMELINE_DATA: TimelineEntry[] = [
  ...
  { id: 1,  year: 2024, period: 'Jun 2024 – Mar 2025',  startDate: '2024-06', endDate: '2025-03', title: 'Successor',                    contribution: 'Gameplay & UI',                                                  engine: 'Unreal Engine',     category: 'professional', categoryLabel: 'Playwood Project',            type: 'game',   status: 'released'        },
  ...
  { id: 16, year: 2026, period: 'Apr – May 2026',      startDate: '2026-04', endDate: '2026-05', title: 'Vinyllo',                      contribution: 'Frontend, routing & Firebase integration',                                   engine: undefined,           category: 'educational',  categoryLabel: 'Lexicon',             type: 'system', status: 'finished'        },
  { id: 15, year: 2026, period: 'Apr – Jun 2026',      startDate: '2026-04', endDate: '2026-06', title: 'Developer Portfolio',          contribution: 'React · TypeScript · custom SVG timeline',                          engine: undefined,           category: 'hobby',                                              type: 'system', status: 'finished'        },
  { id: 19, year: 2026, period: 'May 2026',              startDate: '2026-05', endDate: '2026-05', title: 'Smart Asset Tracking System',       contribution: 'Arkitektur, split TPH-hierarki, konsol + REST API utan kodduplicering', engine: undefined,           category: 'educational',  categoryLabel: 'Lexicon',             type: 'system', status: 'finished'        },
  { id: 18, year: 2026, period: 'May – Jun 2026',       startDate: '2026-05', endDate: '2026-06', title: 'JMDB – Movie Discovery Platform',  contribution: 'Full-stack solo — MVC, SignalR, TMDB API integration',              engine: undefined,           category: 'educational',  categoryLabel: 'Lexicon',             type: 'system', status: 'finished'        },
  { id: 17, year: 2026, period: 'Jun 2026 →',          startDate: '2026-06',                     title: 'FlowTrack',                    contribution: 'Full-stack solo — architecture, backend, frontend, deployment',       engine: undefined,           category: 'educational',  categoryLabel: 'Lexicon',             type: 'system', status: 'in-development', ongoing: true },
];
