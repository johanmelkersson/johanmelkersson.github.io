...
export const TIMELINE_DATA: TimelineEntry[] = [
  ...
  { id: 17, year: 2026, period: 'May 2026 →',          startDate: '2026-05',                     title: 'Project Mila',                 contribution: 'Game engine · Canvas API · Web Audio API',                           engine: undefined,           category: 'hobby',                                              type: 'game',   status: 'in-development', ongoing: true },
];
