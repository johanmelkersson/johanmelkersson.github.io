...
export const TIMELINE_DATA: TimelineEntry[] = [
  ...
  { id: 15, year: 2026, period: 'Apr 2026 →',          startDate: '2026-04',                     title: 'Developer Portfolio',          contribution: 'React · TypeScript · custom SVG timeline',                          engine: undefined,           category: 'hobby',                                              type: 'system', status: 'in-development', ongoing: true },
  { id: 17, year: 2026, period: 'Jun 2026',            startDate: '2026-06', endDate: '2026-06', title: 'FlowTrack',                    contribution: 'Full-stack solo — architecture, backend, frontend, deployment',       engine: undefined,           category: 'educational',  categoryLabel: 'Lexicon',             type: 'system', status: 'finished'        },
];
